...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 06 Février 2017 à 15:48
...
--
-- Structure de la table `coefficient_confiance`
--

CREATE TABLE `coefficient_confiance` (
  `id` int(11) NOT NULL,
...
--
-- Structure de la table `coefficient_notoriete`
--

CREATE TABLE `coefficient_notoriete` (
  `id` int(11) NOT NULL,
  `coefficient` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Structure de la table `coefficient_prescription`
--

CREATE TABLE `coefficient_prescription` (
  `id` int(11) NOT NULL,
  `coefficient` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `compte_rendu_visite` (
  ...
  `id_coefficient_confiance` int(11) NOT NULL,
  `id_coefficient_notoriete` int(11) NOT NULL,
  `id_coefficient_prescription` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `praticien` (`id`, `nom`, `prenom`, `telephone_fixe`, `telephone_portable`, `mail`, `date_derniere_visite`, `id_fonction_praticien`, `id_type_praticien`, `id_activite`, `id_lieu`, `id_specialite`) VALUES
(1, 'Barack', 'Obama', '0485968754', '0698754185', 'test@test.com', '2017-02-03 00:00:00', 1, 1, NULL, 1, 1);
...
INSERT INTO `utilisateur` (`id`, `nom`, `prenom`, `date_embauche`, `date_creation`, `date_modification`, `telephone_portable`, `telephone_fixe`, `mail`, `id_laboratoire`, `id_service_comptable`, `id_fonction_utilisateur`, `id_activite`, `id_lieu`) VALUES
(1, 'spadaro', 'florian', '2016-06-06', '2016-08-10 00:00:00', '2016-11-12 00:00:00', NULL, NULL, 'spadaro.florian@outlook.fr', 1, NULL, 1, NULL, 1);
...
('AA-689-BF', NULL, 125000, 1, NULL, 1, 1, 1);
...
CREATE TABLE `vehicule_utilisateur` (
  ...
  `id_parc_automobile_arrivee` int(11) NOT NULL,
...
--
-- Index pour la table `coefficient_confiance`
--
ALTER TABLE `coefficient_confiance`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `coefficient_notoriete`
--
ALTER TABLE `coefficient_notoriete`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `coefficient_prescription`
--
ALTER TABLE `coefficient_prescription`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `compte_rendu_visite`
  ...
  ADD KEY `id_coefficient_confiance` (`id_coefficient_confiance`),
  ADD KEY `id_coefficient_notoriete` (`id_coefficient_notoriete`),
  ADD KEY `id_coefficient_prescription` (`id_coefficient_prescription`);
...
--
-- AUTO_INCREMENT pour la table `coefficient_confiance`
--
ALTER TABLE `coefficient_confiance`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `coefficient_notoriete`
--
ALTER TABLE `coefficient_notoriete`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `coefficient_prescription`
--
ALTER TABLE `coefficient_prescription`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `compte_rendu_visite`
  ...
  ADD CONSTRAINT `compte_rendu_visite_ibfk_2` FOREIGN KEY (`id_echantillon`) REFERENCES `echantillon` (`id`),
  ADD CONSTRAINT `compte_rendu_visite_ibfk_3` FOREIGN KEY (`id_praticien`) REFERENCES `praticien` (`id`),
  ADD CONSTRAINT `compte_rendu_visite_ibfk_4` FOREIGN KEY (`id_remplacant_praticien`) REFERENCES `remplacant_praticien` (`id`),
  ADD CONSTRAINT `compte_rendu_visite_ibfk_5` FOREIGN KEY (`id_produit`) REFERENCES `produit` (`id`),
  ADD CONSTRAINT `compte_rendu_visite_ibfk_6` FOREIGN KEY (`id_utilisateur`) REFERENCES `utilisateur` (`id`),
  ADD CONSTRAINT `compte_rendu_visite_ibfk_7` FOREIGN KEY (`id_coefficient_confiance`) REFERENCES `coefficient_confiance` (`id`),
  ADD CONSTRAINT `compte_rendu_visite_ibfk_8` FOREIGN KEY (`id_coefficient_notoriete`) REFERENCES `coefficient_notoriete` (`id`),
  ADD CONSTRAINT `compte_rendu_visite_ibfk_9` FOREIGN KEY (`id_coefficient_prescription`) REFERENCES `coefficient_prescription` (`id`);
...
ALTER TABLE `praticien`
  ...
  ADD CONSTRAINT `praticien_ibfk_3` FOREIGN KEY (`id_activite`) REFERENCES `activite` (`id`),
...
--
ALTER TABLE `remplacant_praticien`
  ADD CONSTRAINT `remplacant_praticien_ibfk_1` FOREIGN KEY (`id_fonction_praticien`) REFERENCES `fonction_praticien` (`id`),
  ADD CONSTRAINT `remplacant_praticien_ibfk_2` FOREIGN KEY (`id_type_praticien`) REFERENCES `type_praticien` (`id`),
  ADD CONSTRAINT `remplacant_praticien_ibfk_3` FOREIGN KEY (`id_praticien`) REFERENCES `praticien` (`id`),
  ADD CONSTRAINT `remplacant_praticien_ibfk_4` FOREIGN KEY (`id_lieu`) REFERENCES `lieu` (`id`),
  ADD CONSTRAINT `remplacant_praticien_ibfk_5` FOREIGN KEY (`id_specialite`) REFERENCES `specialite` (`id`);
...
ALTER TABLE `utilisateur`
  ...
  ADD CONSTRAINT `utilisateur_ibfk_5` FOREIGN KEY (`id_activite`) REFERENCES `activite` (`id`),
