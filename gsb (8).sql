...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 24 Avril 2017 à 12:54
...
INSERT INTO `frais` (`id`, `montant`, `commentaire`, `date`, `id_utilisateur`, `id_type_frais`) VALUES
(1, 156, 'test', '2016-02-28', 1, 2),
(6, 111, 'TEST DEPUIS LE SITE', '2017-04-15', 1, 1),
(7, 145, 'htdhdfd', '2017-04-14', 2, 1);
...
(1, '../pj/015e379018bb9df26073b2a7c8bedbd6.txt', 'test.txt', 6),
(2, '../pj/213c73da07a54096c78d36f84eb8ea78.docx', 'FICHE E4 SITE.docx', 7);
...
(1, 'Barack', 'Obamaze2', '0485968754', '0698754185', 'test@test.com', '2017-02-03 00:00:00', 1, 1, 1, 1);
...
(2, 'icoges', 'effets icoges', 'contre indication icoges', '1 matin', 'adulte de plus de 20 ans', 1, 1);
